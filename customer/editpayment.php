...
$holder = $_SESSION['hname'];
$disp="SELECT * FROM `payment` WHERE `hodername` = '$holder'";
...
<table border="1">
                  ...
                  <tr>
                    ...
                    <td class="center">
                      <form method="POST">
                    <input class="small" size=1 type="txt" name="nam" value= <? echo $quandity ?>>
                    </td>
                    <td class="center">
                    <?php echo $row['mprice'];?>
                    </td>
...
<form method="POST">
  <h4>payment</h4>
        <B>card type:</B><input type="text" name="name" value= <?php $row1['ctype'] ?>><br><br>
        <b>card number:</b><input type="password" name="number" value=<?php $row1['cnumber'] ?>><br><br>
        <b>cvv number:</b><input type="text" name="cvv" value=<?php $row1['cvvnumber'] ?>><br><br>
        <b>holder name:</b><input type="text" name="holder" value=<?php $row1['holdername'] ?>><br><br>
        <b>product price:</b><input type="number" name="price" value=<?php $row1['iprice'] ?>><br><br>
        <input type="submit" name="change" value="payment">
   </form>
   ?<?php } ?>
         <?php
         ...
         $sql = "UPDATE `payment` SET `ctype`='$cardtype',`cnumber`='$cardnum',`cvvnumber`='$cvv',`holdername`='$holdername',`iprice`='$price' WHERE `holdername` = '$holder'";

         if(mysqli_query($conn,$sql))
         {
            echo"<script>alert('updation is succussfully completed');</script>
